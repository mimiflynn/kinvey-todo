            ...
            },
            {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        padding: '20 0',
                        store: {type: 'tasks'},
                        itemTpl: '<div class="item-remove"></div> <div class="item-edit"></div> <p <tpl if="completed == true">class="item-completed"</tpl>>{title}</p> ',
                        listeners: {
                            itemtap: function (dataview, index, target, record, event) {
                                ...
                                } else if (event.getTarget('.item-edit')) {
                                    view.fireEvent('edittask', record);
                                } else {
